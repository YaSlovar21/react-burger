...
export const INGRS_URL = '/ingredients';
export const ORDER_URL = '/orders';

export const PASSWORD_RESET_URL = '/password-reset'; //отправляем емэйл
export const PASSWORD_RESET_WITH_CODE_URL = '/password-reset/reset'; //отправляем новый пароль с кодом верификации
...
export const USER_URL = '/auth/user'; // эндпоинт получения данных о пользователе.
